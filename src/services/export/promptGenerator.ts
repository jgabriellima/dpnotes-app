...
const translations = {
  pt: {
    summaryTitle: '## Sumário das Anotações',
    annotatedTextTitle: '## Texto Anotado',
    labelPrefix: 'Label',
    textNotePrefix: 'Nota',
    audioTranscriptionPrefix: 'Transcrição de áudio',
    instructions: 'Por favor, processe o texto abaixo considerando as anotações fornecidas.',
  },
  en: {
    summaryTitle: '## Annotations Summary',
    annotatedTextTitle: '## Annotated Text',
    labelPrefix: 'Label',
    textNotePrefix: 'Note',
    audioTranscriptionPrefix: 'Audio transcription',
    instructions: 'Please process the text below considering the provided annotations.',
  },
  es: {
    summaryTitle: '## Resumen de Anotaciones',
    annotatedTextTitle: '## Texto Anotado',
    labelPrefix: 'Etiqueta',
    textNotePrefix: 'Nota',
    audioTranscriptionPrefix: 'Transcripción de audio',
    instructions: 'Por favor procesa el texto a continuación considerando las anotaciones proporcionadas.',
  },
};
